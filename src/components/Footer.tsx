  ...
  return (
    <footer className="bg-black overflow-hidden">
      ...
      <div className="max-w-[95rem] mx-auto px-10">
        <div className="py-8 xl:py-28 items-center">
          <div className="flex items-center justify-between">
            <h2 className="uppercase leading-tight text-white text-7xl font-bold">
              DESIGN NEWS TO
              <br />
              YOUR INBOX
            </h2>
            <div className="flex gap-3">
              <NewsletterSignUp
                formClassName="flex-col gap-4"
                formFieldsClassName="flex gap-3 w-full"
                inputClassName="h-full w-[300px]"
                buttonClassName="bg-white text-black hover:text-white h-full"
              />
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-wrap flex-col md:flex-row justify-between gap-6 py-3 lg:pt-[6rem] lg:pb-[4.0625rem] w-full">
          <p className="font-regular text-white">
            Designed by <Link href="https://templates.gola.io/templates">Pawel Gola</Link>. All
            content belongs to their respective copyright holders.
          </p>
        </div>
      </div>
    </footer>
